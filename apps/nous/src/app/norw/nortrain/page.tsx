...
const tools = [
  {
    id: 'practice-room',
    name: 'Practice Room',
    description: 'Train your communication skills with AI personas. Get real-time feedback and improve your pitch.',
    icon: Mic,
    href: '/norw/nortrain/practice-room',
  ...
  },
  {
    ...
    icon: Users,
    href: '/norw/nortrain/agent-lab',
    color: 'bg-norw/20 text-norw',
  },
]

export default function NorTrainPage() {
  return (
    <div className="min-h-screen bg-navy-900">
      <div className="border-b border-white/10 px-6 py-6">
        <div className="flex items-center gap-3 mb-2">
          <div className="w-3 h-3 rounded-full bg-norw" />
          <h1 className="text-2xl font-semibold text-white">NorTrain</h1>
        </div>
        <p className="text-white/60">AI-powered training to sharpen your real estate skills</p>
      </div>
